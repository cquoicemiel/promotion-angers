...
const CustomImage = (props) => {
    return(
        <span className='flex flex-col w-full'>
            <Image className='rounded-sm object-cover w-full' width={1000} height={1000} quality={65} alt={props.label} src={props.src}/>
            <span className='text-gray-400 font-thin  text-center w-full text-xl py-0.5'>{props.label}</span>
        </span>
    )
}
    ...
    return(
        <div onClick={() => {
            ...
            <span className={`rounded-md flex items-center justify-between ${props.state && "bg-white px-8 md:px-16 py-8"}`}>
                <span className={`transition-none capitalize flex items-center text-2xl md:text-2xl xl:text-3xl font-bold text-center ${props.state ? "justify-start" : "justify-center"}`}>{props.title}</span>
  ...
  const scroll = () => {
    ...
    return(
            <div className='flex flex-col min-h-screen bg-gray-100'>
                <Header/>
                <div style={{minHeight: '40rem'}} className={`${(!first && !second && !third) && "py-16"} gap-8  md:gap-0  transition-all flex flex-col md:flex-row relative w-full px-6 xl:px-24 justify-around items-center md:items-start  z-20`}>
                    ...
                    <Card state={first} setState={setFirst} title={"I - une ville en constante évolution"} text={"Voyons comment Angers se maintient en évolution en ne cessant jamais d'évoluer dans ses infrastructures, ses activités, et sa population."}>
                        <span className='text-2xl flex flex-col md:flex-row gap-8 justify-around'>
                            ...
                            <span className='flex h-full flex-col justify-start gap-2  md:w-1/2 xl:w-1/3'>
                                <CustomImage label={"Tramway angevin"} src={require('../assets/tram.webp')}/>
                                <CustomImage label={"Patinoire IceParc"} src={require('../assets/iceparc.webp')}/>
                                <CustomImage label={"Quartier d'affaires"} src={require('../assets/cbd.webp')}/>
                                <CustomImage label={"Centre ville de nuit"} src={require('../assets/angersnuit.webp')}/>
                            </span>
                        </span>
                    </Card>
                    ...
                    <Card state={second} setState={setSecond} title={"II - un atmosphère de vie agréable"} text={"La vie à Angers est agréable, la météo et l'aspect sociale de la ville apporte une vraie plus value en comparaison aux autres métropoles du pays."}>
                        <span className='text-2xl flex flex-col md:flex-row gap-8 justify-around'>
                            ...
                            <span className='flex h-full flex-col justify-start gap-2 w-1/3'>
                                <CustomImage label={"Avenue Jeanne d'Arc"} src={require('../assets/verdure.webp')}/>
                                <CustomImage label={"Terrabotanica"} src={require('../assets/terrabotanica.webp')}/>
                                <CustomImage label={"Navette gratuite"} src={require('../assets/navette.webp')}/>
                            </span>
                        </span>
                    </Card>
                    ...
                    <Card state={third} setState={setThird} title={"III - un grand patrimoine culturel et éducatif"} text={"Cette ville est dôtée d'une grande richesse culturelle, notamment dûe à son passé historique datant du Moyen-Âge. Le patrimoine Éducatif de cette ville réputée étudiante est aussi très dense."}>
                        <span className='text-2xl flex flex-col md:flex-row gap-8 justify-around'>
                            ...
                            <span className='flex h-full flex-col justify-start gap-2 w-1/3'>
                                <CustomImage label={"Campus UA"} src={require('../assets/ua.webp')}/>
                                <CustomImage label={"Les Beaux-Arts"} src={require('../assets/beauxarts.webp')}/>
                                <CustomImage label={"Chateau du Roi René"} src={require('../assets/chateau.webp')}/>
                                <CustomImage label={"Vignes angevines"} src={require('../assets/vignes.webp')}/>
                            </span>
                        </span>
                    </Card>

                    <Image onClick={() => scroll()} className={`${down ? "-rotate-90" : "rotate-90"} fixed right-8 bottom-8 self-center cursor-pointer h12 w-12 transition-all animate-pulse md:hover:animate-none bg-gray-300 rounded-full z-20 p-2`} src={require('../assets/arrow.png')} alt={"Descendre"}/>
                </div>
